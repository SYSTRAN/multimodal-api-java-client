...
import net.systran.platform.multimodal.client.model.MultipartResponse;
import net.systran.platform.multimodal.client.auth.Authentication;
import net.systran.platform.multimodal.client.auth.HttpBasicAuth;
import net.systran.platform.multimodal.client.auth.ApiKeyAuth;
import net.systran.platform.multimodal.client.auth.OAuth;
